...
PRINT_SETTINGS = {
    ...
    "yaesu vx7r": [
        "monochrome,1-111,duplex,fit,paper=letter",
    ],
    "tandy 100": [
    ...
    "Elecraft KX2": [
        "color,1-76,duplexshort,fit,paper=letter,landscape",
    ],
    "Canon Elph 190 IS": [
        "color,1-143,duplexshort,fit,paper=letter,landscape",
    ],
    "red dsmc2 dragon-x": [
    ...
    "nikon d80": [
        "monochrome,1-162,duplex,fit,paper=letter",
    ],
    "kenwood tm-v71a": [
        "monochrome,1-107,duplex,fit,paper=letter",
    ],
    "yaesu ft-857d": [
        "monochrome,1-136,duplex,fit,paper=letter",
    ],
    "Tandy Color Computer 1 Service": [
        "monochrome,1-60,duplex,fit,paper=letter",
    ],
    "pentax 645z": [
        "color,1,simplex,fit,paper=letter",
    ...
    "canon powershot sx730 hs": [
        "color,1-189,duplexshort,fit,paper=letter,landscape",
    ],
    "pentax kf": [
        "monochrome,1,simplexshort,fit,paper=letter,landscape",
        "monochrome,2,simplexshort,fit,paper=letter,landscape",
        "monochrome,3-152,duplexshort,fit,paper=letter,landscape",
    ],
    "pentax k3 iii": [
        "monochrome,1,simplexshort,fit,paper=letter,landscape",
        "monochrome,2,simplexshort,fit,paper=letter,landscape",
    ...
    "leica d-lux 7": [
        "color,1-293,duplex,fit,paper=letter",
    ],
    "leica d-lux 8": [
        "color,1-215,duplex,fit,paper=letter",
    ],
   ...
   "hp15c-ce-afh-en": [
    ...
    "tascam dp-24sd": [
        "monochrome,1-8,duplex,fit,paper=letter",
        "color,9-18,duplex,fit,paper=letter",
        "monochrome,19-22,duplex,fit,paper=letter",
        "color,23-70,duplex,fit,paper=letter",
        "monochrome,71-80,duplex,fit,paper=letter",
    ],
    "boss dr-880": [
        "monochrome,1-168,duplex,fit,paper=letter",
    ],
    ...
    "tandy Color Computer 3 Service": [
        "monochrome,1-129,duplex,fit,paper=letter",
    ],
    "canon eos 6d": [
...
# normalize keys once
PRINT_SETTINGS = {k.lower(): v for k, v in PRINT_SETTINGS.items()}
